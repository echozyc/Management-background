    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                <el-form :inline="true" :model="searchData.assetSelect" class="demo-form-inline">
                    ...
                    <el-form-item label="还款状态">
                        <el-select v-model="searchData.assetSelect.region" placeholder="还款状态">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="date" label="匹配流水ID" sortable width="150"></el-table-column>
                <el-table-column prop="name" label="投资人名称" width="120"></el-table-column>
                <el-table-column prop="address" label="借款订单号" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="借款人" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="借款人所在地" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="性别" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="借款金额（$）" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="借款天数" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="起投日期" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="到期日期" :formatter="formatter"></el-table-column>
                <el-table-column prop="address" label="还款状态" :formatter="formatter"></el-table-column>
            </el-table>
